...
namespace Digitalantiz.Modules.Ticketing.Infrastructure.Database.Migrations
{
    [DbContext(typeof(TicketingDbContext))]
    [Migration("20241228045707_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Events.TicketType", b =>
                {
                    b.HasOne("Digitalantiz.Modules.Ticketing.Domain.Events.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Orders.Order", b =>
                {
                    b.HasOne("Digitalantiz.Modules.Ticketing.Domain.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Digitalantiz.Modules.Ticketing.Domain.Orders.OrderItem", b =>
                {
                    b.HasOne("Digitalantiz.Modules.Ticketing.Domain.Orders.Order", null)
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("Digitalantiz.Modules.Ticketing.Domain.Events.TicketType", null)
                        .WithMany()
